...
// thirty-one of the thirty-eight have a written melody.
...
function App() {
	...
	const ALL_COUNTRIES: Country[] = [sy, iq, lb, ae, om, us, th, tr, gr, se, al, at, au, be, ca, ch, cz, de, dk, eg, es, fr, gb, hu, id, ir, it, jp, lu, nl, no, pe, pl, ps, pt, tn, ua, va].filter(isVisible)
