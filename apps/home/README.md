[![Version](https://img.shields.io/badge/version-0.21.0-blue.svg)](https://github.com/amerharb/sawt)
# Home

The landing page for [sawt](../../README.md), deployed at
**https://www.sawt.info**. Five large buttons, one per app, each linking to that
app's own subdomain.
...
names as the five apps (`--bg`, `--fg`, `--button-bg`, `--active-bg`) so the
...
A sixth Vercel project alongside the five apps — same setup as the others (see
the [root README](../../README.md#deploying-five-vercel-projects-one-repo)), with
...
The five button icons are each app's own favicon. `public/favicon.svg` for this
