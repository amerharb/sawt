[![Version](https://img.shields.io/badge/version-0.36.0-blue.svg)](https://github.com/amerharb/week)
# Week
...
- Play together (🏟️ **the courtyard**, inside game mode): the same round, on two
  ...
  number they were told). The host presses ▶️ and the same day is asked of
