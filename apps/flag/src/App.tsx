...
function App() {
	...
	const ALL_COUNTRIES: Country[] = [ad, ae, af, al, ao, ar, at, au, az, ba, bd, be, bf, bg, bj, bo, br, bw, by, ca, cd, cf, cg, ch, ci, cl, cm, cn, co, cu, cz, de, dk, dz, ec, eg, er, es, et, fi, fr, ga, gb, gbSct, ge, gh, gi, gn, gr, gt, gy, hn, hr, hu, id, ie, ind, iq, ir, is, it, jo, jp, ke, kg, kh, kp, kr, kz, la, lb, lk, lr, lu, ly, ma, mg, ml, mm, mn, mr, mw, mx, my, mz, na, ne, ng, ni, nl, no, np, nz, om, pa, pe, pg, ph, pk, pl, ps, pt, py, ro, rs, ru, sa, sd, se, sk, sl, sn, so, sr, ss, sy, td, th, tj, tm, tn, tr, tz, ua, ug, us, uy, uz, va, ve, vn, ye, za, zm, zw].filter(isVisible)
