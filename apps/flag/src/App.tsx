...
function App() {
	...
	const ALL_COUNTRIES: Country[] = [ad, ae, al, ao, ar, at, au, ba, be, bg, br, ca, cd, ch, cn, cz, de, dk, dz, eg, es, fr, gb, gbSct, gi, gr, hr, hu, id, ind, iq, ir, is, it, jp, kz, lb, lu, ly, ma, ml, mn, mx, ne, nl, no, om, pe, pl, ps, pt, rs, ru, sa, sd, se, sk, sy, td, th, tn, tr, ua, us, va].filter(isVisible)
