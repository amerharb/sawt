...
function App() {
	...
	const ALL_COUNTRIES: Country[] = [ad, ae, al, ao, ar, at, au, ba, be, bg, bo, br, ca, cd, ch, cn, co, cz, de, dk, dz, eg, es, et, fr, gb, gbSct, gi, gr, hr, hu, id, ind, iq, ir, is, it, jp, kz, lb, lu, ly, ma, ml, mn, mr, mx, na, ne, ng, nl, no, om, pe, pk, pl, ps, pt, rs, ru, sa, sd, se, sk, sy, td, th, tn, tr, tz, ua, us, va, ve, za].filter(isVisible)
