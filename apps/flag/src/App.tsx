...
function App() {
	...
	const ALL_COUNTRIES: Country[] = [ad, ae, af, al, ao, ar, at, au, ba, be, bf, bg, bo, br, bw, ca, cd, cf, cg, ch, ci, cl, cm, cn, co, cz, de, dk, dz, ec, eg, es, et, fi, fr, ga, gb, gbSct, gi, gn, gr, hr, hu, id, ind, iq, ir, is, it, jp, ke, kz, lb, lu, ly, ma, mg, ml, mm, mn, mr, mx, my, mz, na, ne, ng, nl, no, nz, om, pe, pg, ph, pk, pl, ps, pt, py, rs, ru, sa, sd, se, sk, so, ss, sy, td, th, tm, tn, tr, tz, ua, ug, us, uz, va, ve, vn, ye, za, zm, zw].filter(isVisible)
