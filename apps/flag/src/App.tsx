...
function App() {
	...
	const ALL_COUNTRIES: Country[] = [ad, ae, af, al, ao, ar, at, au, ba, be, bg, bo, br, bw, ca, cd, cf, cg, ch, cl, cm, cn, co, cz, de, dk, dz, eg, es, et, fi, fr, gb, gbSct, gi, gr, hr, hu, id, ind, iq, ir, is, it, jp, ke, kz, lb, lu, ly, ma, mg, ml, mm, mn, mr, mx, mz, na, ne, ng, nl, no, om, pe, pg, pk, pl, ps, pt, py, rs, ru, sa, sd, se, sk, so, ss, sy, td, th, tm, tn, tr, tz, ua, us, uz, va, ve, ye, za, zm, zw].filter(isVisible)
