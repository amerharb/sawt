...
function App() {
	...
	const ALL_COUNTRIES: Country[] = [ad, ae, af, al, am, ao, ar, at, au, az, ba, bd, be, bf, bg, bi, bj, bo, br, bt, bw, by, bz, ca, cd, cf, cg, ch, ci, cl, cm, cn, co, cr, cu, cz, de, dj, dk, dom, dz, ec, ee, eg, er, es, et, fi, fr, ga, gb, gbSct, ge, gh, gi, gl, gn, gq, gr, gt, gw, gy, hn, hr, ht, hu, id, ie, ind, iq, ir, is, it, jo, jp, ke, kg, kh, kp, kr, kz, la, lb, lk, lr, ls, lt, lu, lv, ly, ma, md, mg, mk, ml, mm, mn, mr, mw, mx, my, mz, na, ne, ng, ni, nl, no, np, nz, om, pa, pe, pg, ph, pk, pl, ps, pt, py, ro, rs, ru, rw, sa, sb, sd, se, sk, sl, sn, so, sr, ss, sy, td, tg, th, tj, tm, tn, tr, tz, ua, ug, us, uy, uz, va, ve, vn, ye, za, zm, zw].filter(isVisible)
