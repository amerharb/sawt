...
const DICTS: Record<string, Partial<Record<string, string>>> = { en, ar, de }
...
// a content language's name in the current UI language — e.g. code "de" →
// "German" (English UI) / "Deutsch" (German UI) — falling back to the given
// native name when that pair isn't translated
