...
function App() {
	...
	const ALL_COUNTRIES: Country[] = [ad, ae, af, al, ao, ar, at, au, ba, be, bg, bo, br, bw, ca, cd, cf, ch, cl, cn, co, cz, de, dk, dz, eg, es, et, fr, gb, gi, gr, hr, hu, id, ind, iq, ir, is, it, jp, kz, lb, lu, ly, ma, mg, ml, mm, mn, mr, mx, mz, na, ne, ng, nl, no, om, pe, pk, pl, ps, pt, rs, ru, sa, sd, se, sk, so, ss, sy, td, th, tn, tr, tz, ua, us, va, ve, za, zm].filter(isVisible)
