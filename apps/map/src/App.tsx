...
function App() {
	...
	const ALL_COUNTRIES: Country[] = [ad, ae, al, ar, at, au, ba, be, bg, br, ca, cd, ch, cn, cz, de, dk, dz, eg, es, fr, gb, gi, gr, hr, hu, ind, iq, ir, is, it, jp, kz, lb, lu, ma, nl, no, om, pl, ps, pt, rs, ru, sa, se, sk, sy, th, tn, tr, ua, us, va].filter(isVisible)
