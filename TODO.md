...
- **Recordings beyond English, German and Swedish** — a hundred and sixty-two
  entries speak those three only (`sounds: ['en', 'de', 'sv']`; German and
  Swedish landed as the first full batches); each still needs its name
  recorded in the other seven sound languages: Arabic, Danish, Albanian,
  Portuguese, Turkish, Persian and Ukrainian. Roughly 1,150 recordings, best
