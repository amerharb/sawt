...
An npm workspace holding six audio-first learning apps and a landing page.
The six share one idea:
...
Vercel needs **one Project per app** — seven, all connected to this one repository.
